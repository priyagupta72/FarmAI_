  ...
  const faqs = [
    {
      q: "What is FarmAI?",
      a:
        "FarmAI is an AI-powered platform that helps with crop recommendations, fertilizer guidance, and disease detection.",
    },
    {
      q: "How accurate are the crop recommendations?",
      a:
        "We use ML models trained on environmental and soil data, tuned for real-world farm conditions.",
    },
    {
      q: "Is FarmAI free to use?",
      a:
        "Yes. Core features are free; optional premium tools are planned for the future.",
    },
    {
      q: "Do I need technical knowledge to use FarmAI?",
      a:
        "No. The interface is simple and guided — built for first-time users and pros alike.",
    },
    {
      q: "Can FarmAI detect crop diseases in real time?",
      a:
        "Yes. By combining image uploads with live weather context, we surface early warnings and suggestions.",
    },
    {
      q: "Which crops are supported?",
      a:
        "Wheat, rice, maize, pulses, several vegetables — with more being added continuously.",
    },
  ];
      ...
      <section className="relative snap-section w-full min-h-screen flex items-center">
        ...
        <div className="mx-auto w-full max-w-7xl px-6 lg:px-10 py-16 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.p
              variants={fadeUp}
              className="inline-block rounded-full bg-white/60 backdrop-blur-md px-4 py-1 text-xs sm:text-sm font-medium text-green-700 ring-1 ring-green-200"
            >
              Oxygen Plant
            </motion.p>
            ...
            <motion.h1
              custom={1}
              variants={fadeUp}
              className="mt-4 text-4xl sm:text-5xl lg:text-7xl font-extrabold tracking-tight"
            >
            ...
            <motion.p
              custom={2}
              variants={fadeUp}
              className="mt-5 max-w-xl mx-auto lg:mx-0 text-gray-600 text-sm sm:text-base"
            >
              Plants reduce stress levels and boost your mood — perfect for your
              home or workspace. A beautiful plant is like having a friend
              around the house.
            </motion.p>
            ...
            <motion.div custom={3} variants={fadeUp} className="mt-8">
              <a
                href="#about"
                className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-green-600 to-emerald-500 px-6 sm:px-8 py-3 text-white font-semibold shadow-lg shadow-emerald-200/40 hover:shadow-emerald-300/60 transition-transform hover:-translate-y-0.5"
              >
                Explore More
      ...
      <section id="about" className="snap-section py-20 bg-gradient-to-b from-white to-green-50">
        <div className="mx-auto w-full max-w-7xl px-6 lg:px-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              <img
                ...
                alt="About FarmAI"
                className="relative w-72 sm:w-96 rounded-3xl shadow-xl ring-1 ring-white/50 border border-white/40 bg-white/40 backdrop-blur-xl"
              />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="text-center lg:text-left"
          >
            <motion.p variants={fadeUp} className="text-green-700 font-semibold">
              Welcome To FarmAI
            </motion.p>
            <motion.h2
              custom={1}
            ...
            <motion.p
              custom={2}
              variants={fadeUp}
              className="mt-4 text-gray-600 max-w-xl mx-auto lg:mx-0"
            >
              We’re revolutionizing crop health management with machine learning.
              Analyze local factors, predict risks, and keep crops healthy for
              better yields — with simple, friendly tools.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      {[
        {
          ...
          desc: "AI-powered suggestions for what to grow, tuned to your climate and soil.",
          href: "/crop",
        },
        {
          icon: <FaSeedling />,
          title: "Fertilizer Recommendation",
          desc: "Pick the right fertilizer for your soil. Improve productivity with less guesswork.",
          href: "/fertilizer",
        },
        {
          icon: <FaHeartbeat />,
          title: "Disease Detection",
          desc: "Weather-aware disease detection to catch risks early and act fast.",
          href: "/upload",
        },
      ].map((card, i) => (
        <motion.div
          ...
          viewport={{ once: true }}
          className="group relative rounded-3xl bg-white/70 backdrop-blur-xl p-6 sm:p-8 shadow-xl ring-1 ring-gray-200/60 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 hover:shadow-[0_0_30px_rgba(16,185,129,0.25)]"
        >
          <div className="relative">
            <div className="w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center rounded-2xl 
              bg-gradient-to-br from-green-600 to-emerald-500 text-white text-2xl sm:text-3xl 
              shadow-lg shadow-emerald-200/50 group-hover:scale-110 transition-transform"
            >
              {card.icon}
            </div>
            ...
            <a
              ...
              className="mt-5 sm:mt-6 inline-flex items-center gap-2 rounded-full 
                bg-gradient-to-r from-green-600 to-emerald-500 px-4 sm:px-5 py-2 sm:py-2.5 
                text-white font-medium shadow-md hover:shadow-lg transition text-sm sm:text-base"
            >
    ...
    <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition h-auto flex flex-col justify-between min-h-[220px] sm:min-h-[240px]">
              ...
              <div className="flex items-center gap-3 sm:gap-4 mt-auto">
                <img
                  src={t.avatar}
                  alt={t.author}
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover ring-2 ring-emerald-200"
                />
                <div>
      ...
      <section id="faq" className="snap-section py-20 bg-gradient-to-b from-white to-green-50">
        <div className="mx-auto w-full max-w-4xl px-6 lg:px-10">
          <h3 className="text-3xl sm:text-4xl font-bold text-center text-green-700 mb-10">
          ...
          <div className="space-y-4">
            {faqs.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="rounded-2xl bg-white/80 backdrop-blur-xl border border-green-200 shadow-sm"
                >
                  <button
                    onClick={() => toggleFAQ(index)}
                    className="w-full flex items-center justify-between px-6 py-4 text-left"
                  >
                    <span className="font-medium text-base sm:text-lg text-green-800">
                      {item.q}
                    </span>
                    <FaChevronDown
